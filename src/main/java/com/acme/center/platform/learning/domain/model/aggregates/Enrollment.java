...
public class Enrollment extends AuditableAbstractAggregateRoot<Enrollment> {
    ...
    public void completedTutorial(TutorialId tutorialId) {
        this.progressRecord.completeTutorial(tutorialId, this.course.getLearningPath());
        // TODO: Publish a domain event for tutorial completion
    }

    public void startedTutorial(TutorialId tutorialId) {
